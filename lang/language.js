$.i18n.lang = $.extend(true, $.i18n.lang || {}, {
  ...
  ru: {
    ...
    geyser_tile_cycle_output: 'Занимает: ${0} кг/клетку, ${1} клеток/цикл',
    ...
    use_up_information:'Соотношения устройств и растений',
    Bristle_Blossom:'Потребление иглоцветом ${0} г/с, Количество ${1}',
    Sleet_Wheat:'Потребление морозной пшеницей ${0} г/с, Количество ${1}',
    Pincha_Pepper:'Потребление перцовым орехом ${0} г/с, Количество ${1}',
    Thimble_Reed:'Потребление тростневиком ${0} г/с, Количество ${1}',
    Oil_Well:'Потребление нефтяным насосом ${0} г/с, Количество ${1}',
    ...
    Carbon_Skimmer:'Потребление отделителем углерода ${0} г/с, Количество ${1}',
  },
